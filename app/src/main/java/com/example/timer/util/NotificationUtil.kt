...
import com.example.timer.TimerNotificationReceiver
import java.text.SimpleDateFormat
import java.util.*


/**
 * This class creates the tools needed to manage the notifications the app will create
 */
class NotificationUtil {
    ...
    companion object {
        ...
        fun showTimerPaused(context: Context){
            val startIntent = Intent(context, TimerNotificationReceiver::class.java)
            startIntent.action = AppConstants.ACTION_START
            val resumePendingIntent = PendingIntent.getBroadcast(context,0,startIntent,
                PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        private fun getBasicNotificationBuilder(context: Context, channelId: String, playSound: Boolean)
            ...
            val notificationSound : Uri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE)
        ...
        private fun <T> getPendingIntentWithStack(context: Context, javaClass: Class<T>): PendingIntent {
            ...
            //with this flag we will not create the action if it is already created
        ...
        private fun NotificationManager.createNotificationChannel(channelId: String,
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                ...
                nChannel.enableVibration(playSound)
